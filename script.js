...
document.getElementById('loveButton').addEventListener('click', function () {
    ...
    The way you walk just shows me who you are
    These full time fights ain't nothing new to us
    But like always all my fault you say
    I don't know how to trust
    I only  <span class="bold-text">love</span> the drugs
    I only wanna fuck
    I don't know how to <span class="bold-text">love</span>
    I don't know how to <span class="bold-text">love</span>
    I don't know how to <span class="bold-text">love</span>
    I don't know how to trust
    I only <span class="bold-text">love</span> the drugs
    ...
    I don't know how to <span class="bold-text">love</span>
    I don't know how to <span class="bold-text">love</span>
    I don't know how to <span class="bold-text">love</span> you for who you are
    This the last song I wrote for you baby
    This the last song I wrote for you baby
    This the last song I wrote for you baby
    This the last song I wrote for you baby
...
document.getElementById('thinkingButton').addEventListener('click', function () {
    ...
    어제보다 더 취해서 집에 가네
    Are you
    <span class="bold-text">Thinking</span> 'bout me (<span class="bold-text">thinking</span> 'bout me)
    <span class="bold-text">Thinking</span> 'bout me (<span class="bold-text">thinking</span> 'bout me)
    <span class="bold-text">Thinking</span> 'bout me, are you <span class="bold-text">thinking</span> 'bout me
    But 사실 너가 없어서
    내가 꿈꿔 왔던 거
    전부 의미가 없어진 건 아니?
    없어진 건 아니?
    ...
    Are you <span class="bold-text">thinking</span> 'bout me
    <span class="bold-text">Thinking</span> 'bout me
    <span class="bold-text">Thinking</span> 'bout me, are you <span class="bold-text">thinking</span> 'bout me
    너한텐 my life's good
    나는 불평 못해
...
document.getElementById('boutButton').addEventListener('click', function () {
    ...
    A youngin from the block like me
    Girl are you sure this what you want?
    Fuck what they be talkin' <span class="bold-text">'bout</span>
    ...
    I know that you, ah
    Don't you know I'd give you everything, ooh
    Don't you know I'd give you everything, ooh
    Back when I was broke
    It was me and bro
    Post up by the street store
...
document.getElementById('youButton').addEventListener('click', function () {
    ...
    hideButtons();
    contentDiv.innerHTML = `<pre class="lyrics">
    Came all this way to see <span class="bold-text">you</span>
    I keep coming back to <span class="bold-text">you</span>
    I know <span class="bold-text">you</span> hate me but I really tried
    I know its late but I just needed time
    But how could <span class="bold-text">you</span> blame me for coming back to <span class="bold-text">you</span>
    How could I forget when we split an angel
    Oh 날 기다려줘 Oh baby
    이젠 지쳤단 말은 말아 Baby
    내가 미안해
    날 용서해줄래
    ...
    나 같은 거리놈 받아줄래
    그 무엇보다 널 사랑해줄게
    <span class="bold-text">You</span> and I 지금 끝나긴 아쉽잖아
    너와 나 우린 진짜 사랑하잖아
    날 용서해
    날 용서해
    날 용서해
...
document.getElementById('butButton').addEventListener('click', function () {
    ...
    hideButtons();
    contentDiv.innerHTML = `<pre class="lyrics">
    술 마시고 전화 좀 하지 말자 나도 똑같게 하게 되잖아
    아침이 오면 넌 또 후회할까 그럴걸 알면서도 난 해 상상
    네가 돌아올까 baby come back 답은 다 알지만 no no no
    그래도 해 상상 네가 날 다시 사랑하는
    상상할 수밖에 이젠 좀 그만해
    네가 돌아와도 내 친군 날 바보 취급하겠지
    <span class="bold-text">But</span> let me tell you something 그런 건 나한텐 nothing
    너도 나처럼 네 마음에 충실했으면 해
    우리가 했었던 good loving 결국엔 또 남이 되려고 한건 아니잖아 shordy
    난 너를 알아 shordy
    다른 여자가 날 알아가는 건 네가 원하는 게 아니잖아 shordy
    왜 거짓말해 shordy
    술 마시고 전화 좀 하지 말자 나도 똑같게 하게 되잖아
    아침이 오면 넌 또 후회할까 그럴걸 알면서도 난 해 상상
    네가 돌아올까 답은 다 알지만 그래도 해 상상
    Cuz 내 생각엔 you're the one
    내 생각엔 you're the one cuz 내 생각엔 you're the one
    Cuz 내 생각엔 you're the one cuz 내 생각엔 you're the one
    You're the one for me
    아침이 오면 나 너의 손을 잡고 내가 망쳐놓은 너의 눈을 봤어
    나 잠시라도 너를 잡고서 너를 차갑게 했던 이 비를 맞고 있어
    아 또 희미해져 내 힘이 널 지키기 위해서였는데
    너의 짐이 날 이미 떠나간 것 같지만 너만은 절대
    'Cause 내 생각엔 you're the only one
    나 계속 기다리고 있어 at the studio
    내 노래 전부 다 너네 뭘 해 내가 너 없는 시간에
    취했어 keep sippin' 42 don julio
    And late night I've been cruisin' down
    The interstate 고장 난 day와 date am I too late
    If I'm late tell me how late
    돌고 돌아 매일이 damn
    술 마시고 전화 좀 하지 말자 나도 똑같게 하게 되잖아
    아침이 오면 넌 또 후회할까 그럴걸 알면서도 난 해 상상
    네가 돌아올까 답은 다 알지만 그래도 해 상상
...
document.getElementById('notButton').addEventListener('click', function () {
    ...
    It's <span class="bold-text">not</span> my fault, I really come from nothing
...
document.getElementById('everyButton').addEventListener('click', function () {
    ...
    행복한 추억들마저
    후회할 이유로 남어
    'Cause you were <span class="bold-text">everything</span> I wanted
    'Cause you were <span class="bold-text">everything</span> I wanted
    이건 사랑인 게 맞아
    But 난 그걸 못 담아
    나 때문에 또 다칠게 뻔하니까
...
document.getElementById('staysButton').addEventListener('click', function () {
    ...
    Don't be afraid
    Being broke is okay
    Nothing ever <span class="bold-text">stays</span> the same
...
document.getElementById('likeButton').addEventListener('click', function () {
    ...
    hideButtons();
    contentDiv.innerHTML = `<pre class="lyrics">
    A youngin from the block <span class="bold-text">like</span> me
    Girl are you sure this what you want?
    내가 여기까지 온 이윤 넌데
    모두가 알잖아 (여기까지 온 이윤 넌데)
    Let my chain hang
    But I still didn't change, hold up (hold up)
    I could tell that
    You're the same just <span class="bold-text">like</span> me, hold up
    I came from nothing, you know this alright
    Can I pull up on you if its alright? Eh, yeah
    나도 이제 자신 있어 그런다 왜
    지금만을 기다려서 그런다 왜
    Damn I really miss you girl
    I'm still thinking 'bout you girl
    Damn I really miss you girl
    Let me see you get down
    Jewelry and some bags and designer clothes
    바리바리 싸왔어 마치 Santa Clause
    너가 보던 헌 발 이젠 Prada thing
    기억나니 들려주곤 한 piano theme
    The piano theme was <span class="bold-text">like</span> this song
    사왔어 너의 네 번째 손에
    닿을 10월의 탄생석
    그 손에 껴주겠니?
    I came from nothing, you know this alright
...
document.getElementById('mineButton').addEventListener('click', function () {
    ...
    hideButtons();
    contentDiv.innerHTML = `<pre class="lyrics">
    내가 원하는건 너 Not someone like you
    너의 흉터와 망가진 마음도
    Uhh 지금 있는 그대로 와줘
    I got you
    넌 해야 해 <span class="bold-text">Mine</span>
    해야 해 <span class="bold-text">Mine</span>
    말해줘 넌 <span class="bold-text">Mine</span>
    말해줘 넌 <span class="bold-text">Mine</span> <span class="bold-text">Mine</span>
    Double C or Louis don't impress her
    단발머리 오늘은 Sun dress
    바람 불면 Paulie 미치겠어
    넌 내 맘 알면서도 Say less
    어디서 배워왔니 Finesse
    시험하네 Yeah she tryna test
    그럼 난 걍 눈 뜨고 당하겠어
    시간은 말야
    뒤돌아보질 않아
    날 잡아달란 말야
    ...
    I'm in love with your demons too
    I don't care what they say about you
    Even if that shit was all true
    시간은 말야
    뒤돌아보질 않아
    날 잡아달란 말야
    날 믿어달란 말야
